...
clear
set obs 40
*gen year=1983+((_n-1)*5)
gen year=1978+_n
*gen timeperiod=_n
*gen period="1978-99" if timeperiod==1
*replace period="2000-2007" if timeperiod==2
*replace period="2008-2019" if timeperiod==3
gen nnodes=.
...
replace timeperiod=3 if year>2008
save,replace
keep if country_obs=="ITALY"


drop if psn_sector=="UNKNOWN"
replace psn_sector="UNIVERSITY" if psn_sector=="GOV NON-PROFIT UNIVERSITY" &  person_ctry_code=="IT" 
replace psn_sector="nonIT_UNIV" if psn_sector=="UNIVERSITY" &  person_ctry_code!="IT" 
tab psn_sector
count
keep if psn_sector=="COMPANY" | psn_sector=="GOV NON-PROFIT" |  psn_sector=="HOSPITAL"   |  psn_sector=="INDIVIDUAL"  |  psn_sector=="UNIVERSITY" |   psn_sector=="nonIT_UNIV" 
count
bysort psn_name : egen nban_psn=nvals(year)
bysort psn_name : egen nbapp_psn=nvals(appln_id)
...
bysort psn_name : keep if _n==1
 ...
 save  "C:\Users\cjoyez\Desktop\Gredeg\Isabel Patstat\newdata\Cent_psn_year`y'_Sector_ITALY.dta",replace
nwdrop if _degree==0
 nwtoedge,  fromvar(psn_sector) tovar(psn_sector)
...
rename to Target
rename test Weight
nwrename test net`y'_ITALY

export delimited "C:\Users\cjoyez\Desktop\Gredeg\Isabel Patstat\newdata\edgelist_Sector_`y'_ITALY.csv", replace


use "C:\Users\cjoyez\Desktop\Gredeg\Isabel Patstat\newdata\Cent_psn_year`y'_Sector_ITALY.dta",clear
gen Id= psn_sector
export delimited "C:\Users\cjoyez\Desktop\Gredeg\Isabel Patstat\newdata\nodelist_Sector_`y'_ITALY.csv",   replace
...
gen country_obs="ITALY"

save "C:\Users\cjoyez\Desktop\Gredeg\Isabel Patstat\newdata\Cent_Sector_yearly_ITALY.dta",replace

nwclear
 forvalues y=1979(1)2018{
append using "C:\Users\cjoyez\Desktop\Gredeg\Isabel Patstat\newdata\Cent_psn_year`y'_Sector_ITALY.dta"
}
save "C:\Users\cjoyez\Desktop\Gredeg\Isabel Patstat\newdata\Cent_Sector_detail_ITALY_yearly.dta",replace

use "C:\Users\cjoyez\Desktop\Gredeg\Isabel Patstat\newdata\Cent_Sector_detail_ITALY_yearly.dta",clear
count

use "C:\Users\cjoyez\Desktop\Gredeg\Isabel Patstat\newdata\Cent_Sector_yearly_ITALY.dta",clear
count
...
use "C:\Users\cjoyez\Desktop\Gredeg\Isabel Patstat\newdata\Cent_Sector_detail_GERMANY_yearly.dta",clear
*append using  "C:\Users\cjoyez\Desktop\Gredeg\Isabel Patstat\newdata\Cent_Sector_detail_ITALY_yearly.dta"
 forvalues y=1979(1)2018{
local n=`y'-1978
